...
int32_t PRESCALER_DIVIDER =
    1; // doc page 2051, can be other values to increase frequency of countdown clock
 ...
 *
 * Note that with PRESCALER_DIVIDER = 0 it is not possible to make one second delay, because 8000 >
 * 4095
 */
...
bool tal_IWDG_enable()
{
    ...
    // I feel like this would overwrite the previous call, but it is what the documentation says to
    // do
