...
#include "common/util/attribute.h"
  ...
  tal_fn_attr_weak void reset_handler(void);
  tal_fn_attr_weak void nmi_handler(void);
  tal_fn_attr_weak void hard_fault_handler(void);
  tal_fn_attr_weak void mem_manage_handler(void);
  tal_fn_attr_weak void bus_fault_handler(void);
  tal_fn_attr_weak void usage_fault_handler(void);
  tal_fn_attr_weak void sv_call_handler(void);
  tal_fn_attr_weak void debug_monitor_handler(void);
  tal_fn_attr_weak void pend_sv_handler(void);
  tal_fn_attr_weak void systick_handler(void);
  tal_fn_attr_weak void irq_0_handler(void);
  tal_fn_attr_weak void irq_1_handler(void);
  tal_fn_attr_weak void irq_2_handler(void);
  tal_fn_attr_weak void irq_3_handler(void);
  tal_fn_attr_weak void irq_4_handler(void);
  tal_fn_attr_weak void irq_5_handler(void);
  tal_fn_attr_weak void irq_6_handler(void);
  tal_fn_attr_weak void irq_7_handler(void);
  tal_fn_attr_weak void irq_8_handler(void);
  tal_fn_attr_weak void irq_9_handler(void);
  tal_fn_attr_weak void irq_10_handler(void);
  tal_fn_attr_weak void irq_11_handler(void);
  tal_fn_attr_weak void irq_12_handler(void);
  tal_fn_attr_weak void irq_13_handler(void);
  tal_fn_attr_weak void irq_14_handler(void);
  tal_fn_attr_weak void irq_15_handler(void);
  tal_fn_attr_weak void irq_16_handler(void);
  tal_fn_attr_weak void irq_17_handler(void);
  tal_fn_attr_weak void irq_18_handler(void);
  tal_fn_attr_weak void irq_19_handler(void);
  tal_fn_attr_weak void irq_20_handler(void);
  tal_fn_attr_weak void irq_21_handler(void);
  tal_fn_attr_weak void irq_22_handler(void);
  tal_fn_attr_weak void irq_23_handler(void);
  tal_fn_attr_weak void irq_24_handler(void);
  tal_fn_attr_weak void irq_25_handler(void);
  tal_fn_attr_weak void irq_26_handler(void);
  tal_fn_attr_weak void irq_27_handler(void);
  tal_fn_attr_weak void irq_28_handler(void);
  tal_fn_attr_weak void irq_29_handler(void);
  tal_fn_attr_weak void irq_30_handler(void);
  tal_fn_attr_weak void irq_31_handler(void);
  tal_fn_attr_weak void irq_32_handler(void);
  tal_fn_attr_weak void irq_33_handler(void);
  tal_fn_attr_weak void irq_34_handler(void);
  tal_fn_attr_weak void irq_35_handler(void);
  tal_fn_attr_weak void irq_36_handler(void);
  tal_fn_attr_weak void irq_37_handler(void);
  tal_fn_attr_weak void irq_38_handler(void);
  tal_fn_attr_weak void irq_39_handler(void);
  tal_fn_attr_weak void irq_40_handler(void);
  tal_fn_attr_weak void irq_41_handler(void);
  tal_fn_attr_weak void irq_42_handler(void);
  tal_fn_attr_weak void irq_43_handler(void);
  tal_fn_attr_weak void irq_44_handler(void);
  tal_fn_attr_weak void irq_45_handler(void);
  tal_fn_attr_weak void irq_46_handler(void);
  tal_fn_attr_weak void irq_47_handler(void);
  tal_fn_attr_weak void irq_48_handler(void);
  tal_fn_attr_weak void irq_49_handler(void);
  tal_fn_attr_weak void irq_50_handler(void);
  tal_fn_attr_weak void irq_51_handler(void);
  tal_fn_attr_weak void irq_52_handler(void);
  tal_fn_attr_weak void irq_53_handler(void);
  tal_fn_attr_weak void irq_54_handler(void);
  tal_fn_attr_weak void irq_55_handler(void);
  tal_fn_attr_weak void irq_56_handler(void);
  tal_fn_attr_weak void irq_57_handler(void);
  tal_fn_attr_weak void irq_58_handler(void);
  tal_fn_attr_weak void irq_59_handler(void);
  tal_fn_attr_weak void irq_60_handler(void);
  tal_fn_attr_weak void irq_61_handler(void);
  tal_fn_attr_weak void irq_62_handler(void);
  tal_fn_attr_weak void irq_63_handler(void);
  tal_fn_attr_weak void irq_64_handler(void);
  tal_fn_attr_weak void irq_65_handler(void);
  tal_fn_attr_weak void irq_66_handler(void);
  tal_fn_attr_weak void irq_67_handler(void);
  tal_fn_attr_weak void irq_68_handler(void);
  tal_fn_attr_weak void irq_69_handler(void);
  tal_fn_attr_weak void irq_70_handler(void);
  tal_fn_attr_weak void irq_71_handler(void);
  tal_fn_attr_weak void irq_72_handler(void);
  tal_fn_attr_weak void irq_73_handler(void);
  tal_fn_attr_weak void irq_74_handler(void);
  tal_fn_attr_weak void irq_75_handler(void);
  tal_fn_attr_weak void irq_76_handler(void);
  tal_fn_attr_weak void irq_77_handler(void);
  tal_fn_attr_weak void irq_78_handler(void);
  tal_fn_attr_weak void irq_79_handler(void);
  tal_fn_attr_weak void irq_80_handler(void);
  tal_fn_attr_weak void irq_81_handler(void);
  tal_fn_attr_weak void irq_82_handler(void);
  tal_fn_attr_weak void irq_83_handler(void);
  tal_fn_attr_weak void irq_84_handler(void);
  tal_fn_attr_weak void irq_85_handler(void);
  tal_fn_attr_weak void irq_86_handler(void);
  tal_fn_attr_weak void irq_87_handler(void);
  tal_fn_attr_weak void irq_88_handler(void);
  tal_fn_attr_weak void irq_89_handler(void);
  tal_fn_attr_weak void irq_90_handler(void);
  tal_fn_attr_weak void irq_91_handler(void);
  tal_fn_attr_weak void irq_92_handler(void);
  tal_fn_attr_weak void irq_93_handler(void);
  tal_fn_attr_weak void irq_94_handler(void);
  tal_fn_attr_weak void irq_95_handler(void);
  tal_fn_attr_weak void irq_96_handler(void);
  tal_fn_attr_weak void irq_97_handler(void);
  tal_fn_attr_weak void irq_98_handler(void);
  tal_fn_attr_weak void irq_99_handler(void);
  tal_fn_attr_weak void irq_100_handler(void);
  tal_fn_attr_weak void irq_101_handler(void);
  tal_fn_attr_weak void irq_102_handler(void);
  tal_fn_attr_weak void irq_103_handler(void);
  tal_fn_attr_weak void irq_104_handler(void);
  tal_fn_attr_weak void irq_105_handler(void);
  tal_fn_attr_weak void irq_106_handler(void);
  tal_fn_attr_weak void irq_107_handler(void);
  tal_fn_attr_weak void irq_108_handler(void);
  tal_fn_attr_weak void irq_109_handler(void);
  tal_fn_attr_weak void irq_110_handler(void);
  tal_fn_attr_weak void irq_111_handler(void);
  tal_fn_attr_weak void irq_112_handler(void);
  tal_fn_attr_weak void irq_113_handler(void);
  tal_fn_attr_weak void irq_114_handler(void);
  tal_fn_attr_weak void irq_115_handler(void);
  tal_fn_attr_weak void irq_116_handler(void);
  tal_fn_attr_weak void irq_117_handler(void);
  tal_fn_attr_weak void irq_118_handler(void);
  tal_fn_attr_weak void irq_119_handler(void);
  tal_fn_attr_weak void irq_120_handler(void);
  tal_fn_attr_weak void irq_121_handler(void);
  tal_fn_attr_weak void irq_122_handler(void);
  tal_fn_attr_weak void irq_123_handler(void);
  tal_fn_attr_weak void irq_124_handler(void);
  tal_fn_attr_weak void irq_125_handler(void);
  tal_fn_attr_weak void irq_126_handler(void);
  tal_fn_attr_weak void irq_127_handler(void);
  tal_fn_attr_weak void irq_128_handler(void);
